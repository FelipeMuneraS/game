...
import Modelo.Prueba2;
import javax.swing.ImageIcon;
import javax.swing.JOptionPane;


public class Escenario2 extends javax.swing.JFrame {
    Prueba2 prueba ;
    boolean[] controlador = new boolean[10];
    int puntaje = 0;
    int indicador = 0;
    Modelo.Reproductor r = new Modelo.Reproductor();
    public Escenario2() {
        initComponents();
    ...
    private void preguntaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_preguntaActionPerformed
        String a = prueba.getPregunta();
        r = new Modelo.Reproductor();
        r.start(a,5);        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Escenario2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Escenario2().setVisible(true);
            }
        });
    }
